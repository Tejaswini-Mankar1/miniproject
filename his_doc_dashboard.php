                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <!--<i class="fas fa-heartbeat"></i><h4 class="page-title">MEDSCAN Dashboard</h4>-->
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-danger border-danger border">
                                            <i class="fa-regular fa-flask" style="color: #74C0FC;"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-danger border-danger border">
                                            <i class="fa-solid fa-pills" style="color: #74C0FC;"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
